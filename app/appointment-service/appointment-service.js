...
// Enable X-Ray middleware to trace all requests
app.use(AWSXRay.express.openSegment('AppointmentService'));
...
// End X-Ray tracing segment after the response is sent
