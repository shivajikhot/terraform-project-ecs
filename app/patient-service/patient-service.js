...
// Enable X-Ray tracing middleware
app.use(AWSXRay.express.openSegment('PatientService'));  // 'PatientService' is the name of your service
...
// Enable X-Ray tracing middleware to close the segment at the end of the request
